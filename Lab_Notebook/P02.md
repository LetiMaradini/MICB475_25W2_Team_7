...
2. /data/microgravity_project/taxonomy.qzv - [taxonomy.qzv](../Backup_Files/QIIME_2/taxonomy.qzv)
3. /data/microgravity_project/taxa-bar-plots.qza
4. /data/microgravity_project/taxa-bar-plots.qzv - [taxa-bar-plot.qzv](../Backup_Files/QIIME_2/taxa-bar-plot.qzv)
5. /data/microgravity_project/table-no-mitochondria-no-chloroplast.qza
6. /data/microgravity_project/table-no-mitochondria-no-chloroplast.qzv - [table-no-mitochondria-no-chloroplast.qzv](../Backup_Files/QIIME_2/table-no-mitochondria-no-chloroplast.qzv)
7. /data/microgravity_project/alpha-rarefaction.qza
8. /data/microgravity_project/alpha-rarefaction.qzv- [alpha-rarefaction.qzv](../Backup_Files/QIIME_2/alpha-rarefaction.qzv)
9. /data/microgravity_project/core-metrics-results/

## Results:
1. Choosing rarefaction depth at 64,411 keep most features (64.32%) and samples (92.14%) and discards 11 samples from 140.

<img src="../Images/QIIME2_analysis/Metadata_filt_by_euth_loc.png">

<img src="../Images/QIIME2_analysis/Metadata_filt_by_condition.png">

<img src="../Images/QIIME2_analysis/Metadata_filt_by_hostID.png">

<img src="../Images/QIIME2_analysis/Metadata_filt_by_time.png">

2. Rarefaction curve with the selected rarefaction depth indicated by the black vertical line

<img src="../Images/QIIME2_analysis/Rarefaction_curve.png">
